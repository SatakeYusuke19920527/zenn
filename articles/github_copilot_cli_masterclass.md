...
- [はじめに](#はじめに)
- [GitHub Copilot CLIをインストールして利用を開始する](#github-copilot-cliをインストールして利用を開始する)
- [GitHub Copilot CLIの利用を終了する](#github-copilot-cliの利用を終了する)
- [GitHub Copilot CLIのモード](#github-copilot-cliのモード)
- [コンテキストを用いた会話](#コンテキストを用いた会話)
- [開発ワークフローでのGitHub Copilot CLIの活用](#開発ワークフローでのgithub-copilot-cliの活用)
  - [ワークフロー1: コードレビュー](#ワークフロー1-コードレビュー)
  - [ワークフロー2: リファクタリング](#ワークフロー2-リファクタリング)
  - [ワークフロー3: デバッグ](#ワークフロー3-デバッグ)
  - [ワークフロー4: テスト生成](#ワークフロー4-テスト生成)
  - [ワークフロー5: Git統合](#ワークフロー5-git統合)
- [組み込みエージェントとカスタムエージェント](#組み込みエージェントとカスタムエージェント)
- [エージェントスキル](#エージェントスキル)
  - [Skill vs Agent vs MCP](#skill-vs-agent-vs-mcp)
  - [Skillがある時・ない時](#skillがある時ない時)
  - [スキルの配置場所](#スキルの配置場所)
  - [Copilot がスキルを見つける方法](#copilot-がスキルを見つける方法)
  - [スキルとエージェントを組み合わせる](#スキルとエージェントを組み合わせる)
  - [skillの管理と共有](#skillの管理と共有)
- [プラグインを利用する](#プラグインを利用する)
...
![](https://storage.googleapis.com/zenn-user-upload/6113eaa864e3-20260404.png)
...
以下のように表示されます。
![](https://storage.googleapis.com/zenn-user-upload/976d2f21326c-20260404.png)
...
```markdown:.github/agents/hello-world.agent.md
---
name: hello-world
...
![](https://storage.googleapis.com/zenn-user-upload/28c0590251fb-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/1763db13e3cd-20260404.png)
...
````markdown:skills/code-checklist/SKILL.md
---
name: code-checklist
...
![](https://storage.googleapis.com/zenn-user-upload/3f17cfb7c390-20260404.png)
...
ちゃんと使ってくれてますね！
![](https://storage.googleapis.com/zenn-user-upload/cdfbb6dd1797-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/60fd1f50a9dc-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/4600cc42ef77-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/5cdfcb623855-20260404.png)
...
筆者の環境は以下のような感じでした。
![](https://storage.googleapis.com/zenn-user-upload/e0df64ecc78d-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/03a85ef79f28-20260404.png)

GitHub Copilotを再起動すると、以下のようにfilesystemサーバーが追加されていることがわかります。
![](https://storage.googleapis.com/zenn-user-upload/cbcde036f1cd-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/57e19e8bf026-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/d7746f1d94fa-20260404.png)

次はWebアクセスツールを追加しましょう。

GitHub Copilot CLIには、任意のURLからコンテンツを取得できる組み込みweb_fetchツールが含まれています。これは、ターミナルから離れることなくREADME、APIドキュメント、リリースノートなどを取得するのに便利です。MCPサーバーは不要です。
...
無事に動作してそうですね。
![](https://storage.googleapis.com/zenn-user-upload/0cfa20b0a31e-20260404.png)

これでMCPの設定は完了です。

## MCPサーバーの利用

![](https://storage.googleapis.com/zenn-user-upload/701f922d60d5-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/415807e57564-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/4dcc72399a1e-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/05647a775479-20260404.png)

確かに作られていますね！
![](https://storage.googleapis.com/zenn-user-upload/ad444c37be22-20260404.png)

Issueの内容も綺麗に書いてくれています。
![](https://storage.googleapis.com/zenn-user-upload/e902a04c4c30-20260404.png)
...
![](https://storage.googleapis.com/zenn-user-upload/b95985d9be5f-20260404.png)
...
PRマージも完了しました！
![](https://storage.googleapis.com/zenn-user-upload/e4154c48b575-20260404.png)

---
title: "【2026年最新版】AIコーディングツール11選 GitHub Copilot/Cursor/Claude/Codex/Devin 徹底比較"
emoji: "🗺️"
...
![](https://static.zenn.studio/user-upload/077d02393a62-20260614.png)
...
一方で、選択肢が増えたことで、こんな相談を良く受けます。

- 「GitHub Copilot 入れたけど、Claude Code の方が良いって聞いた...結局どっち？」
- 「Devin は月 $500 って聞いてたけど今いくら？コスパは？」
- 「会社で導入したい。SSO・監査ログ・IP補償に対応してるのは？」
- 「Claude Code と Codexはどっちが推論強い？」
- 「Azure / AWS / Google Cloud 環境で使うなら何が最適？」
- 「Antigravity？Kiro？新しいツール多すぎて追いきれない...」

本記事は、**代表的な11ツールを全観点で横並び比較**して、どのツールが自分の組織に合うのかわかるように記載してみました。

代表的な **AI コーディングツール / AI コーディングエージェント** を整理し、それぞれの特徴、強み、利用シーンをGitHub Copilotと比較する形で各ツールの優位性を理解していきます。
...
本記事の作成にあたり参照した各ツールの公式サイト・Pricingページを以下にまとめます。詳細仕様や最新情報は各公式ドキュメントをご確認ください。

| ツール | 公式サイト | Pricing |
| --- | --- | --- |
| GitHub Copilot | [公式](https://github.com/features/copilot) | [Plans](https://github.com/features/copilot/plans) |
| Cursor | [公式](https://cursor.com/) | [Pricing](https://cursor.com/pricing) |
| Claude Code | [公式](https://www.anthropic.com/product/claude-code) | [Pricing](https://www.anthropic.com/pricing) |
| OpenAI Codex | [公式](https://openai.com/codex/) | [API Pricing](https://openai.com/api/pricing/) |
| Devin | [公式](https://devin.ai/) | [Pricing](https://devin.ai/pricing) |
| Windsurf | [公式](https://windsurf.com/) | [Pricing](https://windsurf.com/pricing) |
| Cline | [公式](https://cline.bot/) | [Pricing](https://cline.bot/pricing) |
| Amazon Q Developer | [公式](https://aws.amazon.com/q/developer/) | [Pricing](https://aws.amazon.com/q/developer/pricing/) |
| Kiro | [公式](https://kiro.dev/) | [Pricing](https://kiro.dev/pricing/) |
| Gemini Code Assist | [公式](https://codeassist.google/) | [Pricing](https://cloud.google.com/products/gemini/pricing) |
| Google Antigravity | [公式](https://antigravity.google/) | [Google AI Plans](https://one.google.com/about/google-ai-plans/) |

その他：[MCP仕様](https://modelcontextprotocol.io/) / [AGENTS.md](https://agents.md/) / [SWE-Bench](https://www.swebench.com/)

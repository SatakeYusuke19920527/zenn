...
提携投資家と提携していないスタートアップ企業向けに、Azure を初めて使用するスタートアップ企業が利用できる Azure スタートアップ クレジット オファーを開始します。これらのスタートアップ企業は、最大 5,000 ドルの無料 Azure クレジットを受け取る資格があります。

詳細については、https://www.microsoft.com/startups をご覧ください。
...
詳細は以下をご覧ください：  
👉 [スタートアップ向け Azure クレジット $1,000 を獲得する | Microsoft Learn](https://learn.microsoft.com/en-us/azure/startups/azure-startup-credit-offer)

### Microsoft for Startups 投資家向けオファリングの特典

Microsoft for Startups Investor Network に提携する投資家は、自社の投資先スタートアップ向けに以下のような **強化された支援** を Microsoft から受けることができます：

- **スタートアップ向け Azure クレジット**
- **専任の Microsoft 担当者によるサポート**
- **GPU クラスタへの優先アクセス**
...
## Microsoft for Startups Investor Network に参加する提携投資家と連携していると受けられる特典
